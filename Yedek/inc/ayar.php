...
$ceviriMenuStr .= '
<a class="menu_list_a '.$m2.'" href="index.php?page=ceviri_alanlari_ve_dilleri&pno='.$m['id'].'&b='.dgs($m['baslik']).'">  '.$m['baslik'].'</a>';
				   else
				   
$ceviriMenuStr .= '
<a class="menu_list_a" href="index.php?page=ceviri_alanlari_ve_dilleri&pno='.$m['id'].'&b='.dgs($m['baslik']).'">  '.$m['baslik'].'</a>';
				   }
...
$kurumsalMenuStr .= '
<a class="menu_list_a '.$m2.'" href="index.php?page=hakkimizda&pno='.$m['id'].'&b='.dgs($m['baslik']).'">  '.$m['baslik'].'</a>';
				   else
				   
$kurumsalMenuStr .= '
<a class="menu_list_a" href="index.php?page=hakkimizda&pno='.$m['id'].'&b='.dgs($m['baslik']).'">  '.$m['baslik'].'</a>';
				   }
...
$hizmetlerMenuStr .= '
<a class="menu_list_a '.$m2.'" href="index.php?page=hizmetler&pno='.$m['id'].'&b='.dgs($m['baslik']).'">  '.$m['baslik'].'</a>';
				   else
				   
$hizmetlerMenuStr .= '
<a class="menu_list_a" href="index.php?page=hizmetler&pno='.$m['id'].'&b='.dgs($m['baslik']).'">  '.$m['baslik'].'</a>';
				   }

...
(function($) {
 ...
 +
	...
	$.fn.fileuploader.defaults = {
        ...
        captions: {
            button: function(options) { return 'Dosya Seçiniz';}, // + (options.limit == 1 ? 'File' : 'Files'); },
            feedback: function(options) { return 'Dosya Seçiniz';}, // (options.limit == 1 ? 'file' : 'files') + ' to upload'; },
            ...
            errors: {
                filesLimit: 'Sadece ${limit} Dosyaların yüklenmesine izin verilir.',
                filesType: 'Sadece ${extensions} Dosyaların yüklenmesine izin verilir.',
                fileSize: '${name} Seçtiğiniz dosyalar çok büyük! Lütfen ${fileMaxSize}MB boyutundan düşük bir dosya yükleyin.',
                filesSizeAll: 'Seçtiğiniz dosyalar çok büyük! Maksimun ${maxSize} MB. boyutunda bir dosya seçin.',
                fileName: '${name} İsimli dosya zaten seçilmiştir.',
                folderUpload: 'Klasör yüklemenize izin verilmiyor.'
            }
        }
	}
})(jQuery);